...
func main(){
  /*d1,_:=costruisci(4,5,"destra")
  d2,_:=costruisci(1,6,"giu")
  d3,_:=costruisci(6,5,"sinistra")
  d4,_:=costruisci(1,4,"su")
  d5,_:=costruisci(3,6,"sinistra")

  robots:=[]Robot{d1,d2,d3,d4,d5}*/
  r1,_ := costruisci(1,1,"destra")
  r2,_ := costruisci(2,2,"giù")
  r3,_ := costruisci(2,5,"su")
  r4,_ := costruisci(2,7,"su")
